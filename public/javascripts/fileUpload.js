...
if(rootStyles.getPropertyValue('--book-cover-width-large') != null && 
    rootStyles.getPropertyValue('--book-cover-width-large') !== ''){/* this javascript file loads before the css files so we need to check if the variable is available first */
    ready();
} else {
